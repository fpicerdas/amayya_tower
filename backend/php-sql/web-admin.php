...
$config["dbase"]			= "ima_builder" ; 		//Database
/** admin **/
$config["email"]			= "admin" ; 		//email for login
$config["password"]			= "d033e22ae348aeb5660fc2140aec35850c4da997" ; 		// sha1(password)
$config["utf8"]			= true; 		
$config["theme"]			= "lumen" ;		// theme name you can get here https://www.bootstrapcdn.com/bootswatch/
...
if($_SESSION["IS_ADMIN"]==true){
	...
	$tags_html .= "</ul>" ;
	$tags_html .= "<h1 class=\"text-muted\">Amaya Tower</h1>" ;
	$tags_html .= "<p>CRM Solutions for Amaya Tower</p>" ;
	$tags_html .= "</div>" ;
	$tags_html .= "</div>" ;
	$tags_html .= "<div class=\"container-fluid\">" ;
	...
	switch($_GET["table"]){
		case "home":
					$tags_html .= "<h4 class=\"page-title\">Amaya Tower</h4>" ;
					$tags_html .= "<div class=\"row\">" ;
...
<div class="form-group">
	...
	<input class="btn btn-primary" type="submit" name="edit" />
		...
		$tags_html .= "<div class=\"container-fluid\">" ;
		$tags_html .= "<div class=\"row\">" ;
		$tags_html .= "<div class=\"col-md-12\"><p class=\"text-left navbar-text\">Copyright &copy; Creative Media Design 2019 - All Rights Reserved</p></div>" ;
		$tags_html .= "</div>" ;
