angular.module("amaya_tower.controllers", [])
...
.controller("side_menusCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	popover_template += "			<a  class=\"item dark-ink\" ng-href=\"#/amaya_tower/about_us\" ng-click=\"popover.hide()\">";
...
//   $ionicLoading.show();
   ...
   localforage.getItem("ima_session", function(err, ima_session){
        ...
        if(ima_session === null){
            ...
            $http.get("http://beliaccessories.com/apps/amayya_tower/rest_api.php?json=me").then(function(resp){
...
$scope.submitUser = function(form){
    ...
    if( angular.isDefined(form)){
        ...
        $http.get("http://beliaccessories.com/apps/amayya_tower/rest_api.php?json=auth").then(function(resp){
            if(resp.data.data.status == 401){
...
.controller("form_userCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	$scope.submitUser = function(){
		...
		$http({
				method:"POST",
				url: "http://beliaccessories.com/apps/amayya_tower/rest_api.php?json=submit&form=user",
...
$rootScope.updateUser = function(){
    ...
    $ionicLoading.show({
		...
		$http({
				method:"POST",
				url: "http://beliaccessories.com/apps/amayya_tower/rest_api.php?json=submit&form=me",
...
.controller("videoCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	$scope.fetchURL = "https://www.googleapis.com/youtube/v3/playlistItems?maxResults=50&part=id,snippet&playlistId=PL8dPuuaLjXtMwV2btpcij8S3YohW9gUGN&key=AIzaSyBPbRYTeJh2k1i-svHRqpIJJ78wFsGbECU";
	// TODO: videoCtrl --|-- $scope.fetchURLp
	$scope.fetchURLp = "https://www.googleapis.com/youtube/v3/playlistItems?maxResults=50&part=id,snippet&playlistId=PL8dPuuaLjXtMwV2btpcij8S3YohW9gUGN&key=AIzaSyBPbRYTeJh2k1i-svHRqpIJJ78wFsGbECU&callback=JSON_CALLBACK";
